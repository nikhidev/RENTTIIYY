...
export const api = createApi({
  ...
  endpoints: (build) => ({
    ...
    updateMangerSettings: build.mutation<
      Manager,
    ...
    >({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        await withToast(queryFulfilled, {
          success: "seettins updated successfully",
    ...
    >({
      query: (filters) => {
        const params = cleanParams({
          ...
          squareFeetMin: filters.squareFeet?.[0] ?? undefined,
          squareFeetMax: filters.squareFeet?.[1] ?? undefined,
    ...
    getProperty: build.query<Property, number>({
      ...
      providesTags: (result, error, id) => [{ type: "PropertiesDetails", id }],
      async onQueryStarted(_, { queryFulfilled }) {
        await withToast(queryFulfilled, {
    ...
    createProperty: build.mutation<Property, FormData>({
      ...
      async onQueryStarted(_, { queryFulfilled }) {
        await withToast(queryFulfilled, {
          success: "Property created succesfully",
    ...
    getPayment: build.query<Payment[], number>({
      query: (leasesId) => `leases/${leasesId}/payments`,
    ...
    getCurrentResidence: build.query<Property[], string>({
