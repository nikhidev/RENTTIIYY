  ...
  return (
    <div className='mb-6'>
        ...
        <div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:gird-cols-3 lg:gird-cols-4 gap-8'>{property.amenities.map((amenity :AmenityEnum)=>{
            ...
            <div  className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-8 mt-4 w-full '>
                {property.highlights.map((highlight:HighlightEnum)=>{
                    ...
                    return(
                        ...
                        key={highlight}
                        className='flex flex-col items-center border rounded-xl py-8 px-4'>
                            <Icon className='w-8 h-8 mb-2 text-purple-600 dark:text-primary-300'
                            />
