...
const ImagePreviews = ({ images }: ImagePreviewsProps) => {
  ...
  return (
    <div className="relative h-[450px] w-full">
      ...
      <button
        onClick={handleNext}
        className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-primary-700 bg-opacity-50 p-2 rounded-full focus:outline-none  focus:ring-secondary-300"
        aria-label="Previous image"
      >
